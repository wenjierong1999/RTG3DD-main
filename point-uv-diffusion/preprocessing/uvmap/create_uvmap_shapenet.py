...
parser.add_argument(
    '--save_folder', type=str, default='/data/leuven/375/vsc37593/my_py_projects/test_preprocess_output_shapenet',
...
def make_uv_map(file_name, category):
    ...
    mesh_path = os.path.join(mesh_dir, category,file_name,'models', model_filename)
...
def generate_data_single(model_id: str, category: str):
...
if __name__ == '__main__':
    ...
    generate_data_single('1acf34aa0cb8f06a19fb4103277a6b93', category='02828884')