...
#create_mlp_components(in_channels=)
...
#     sa_blocks=sa_blocks, extra_feature_channels=6, with_se=True, embed_dim=64,
#     use_att=True, dropout=0.2,
#     width_multiplier=1, voxel_resolution_multiplier=1
# )
# print("SA Layers:")
...
class PVCNN2Base(nn.Module):
    ...
    def __init__(self, num_classes, embed_dim, use_att, dropout=0.1,
        ...
        self.in_channels = extra_feature_channels + 3 # xyz + extra_feature_channels...
    ...
    def forward(self, inputs, t):
        ...
        for i, sa_blocks  in enumerate(self.sa_layers):
            in_features_list.append(features) # save output features
