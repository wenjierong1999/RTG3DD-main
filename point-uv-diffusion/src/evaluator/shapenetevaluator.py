        ...
        with torch.no_grad():
            for batch_idx, batch in enumerate(dataloader):
                ...
                for i in range(images.size(0)):
                    ...
                    # NOTE: change gt_rendered_img_path for different dataset
                    gt_rendered_img_path = Path(self.preprocessed_data_folder) / 'clip_image_data' / obj_c / f'{obj_name}.png'
                    shutil.copyfile(
                    ...
                    shutil.copyfile(
                        ...
                        str(output_save_path / 'gt_rendered_image.png')
                    )
                end_time = time.time()
